...
<div class="row page-content">
   ...
   <?php get_template_part( 'template-parts/content', 'breadcrumb' ); ?>
	...
	<div id="primary" class="content-area">
        ...
        echo '</div>';
        echo '<div class="row">';
		echo ' <div class="small-6 columns"><a href="/mylccc/lcdeptdir_deptartments/academic-and-learner-services/">View Directory by Department</a></div>';
		echo ' <div class="small-6 columns text-right"><a href="/mylccc/faculty_staff_dir/">Return to Main Directory</a></div>';
		echo '</div>';
